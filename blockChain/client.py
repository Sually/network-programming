...
class RClient(Protocol):
    ...
    def dataReceived(self, data):
        ...
        hsh, nounce = BitcoinMiner(_clientID).miner(hashed, '00000')
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 5:
        ...
        exit(1)
    _clientID = str(sys.argv[1]) #hashid
    _rnd = str(sys.argv[2]) #字符串
    _uid = int(sys.argv[4])  # 20001
    _port = int(sys.argv[3])  # 1
    client = Client()
